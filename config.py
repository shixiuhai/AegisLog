...
# 从映射表里提取英文类型和中文类型
ATTACK_TYPES_EN = list(ATTACK_TYPE_MAPPING.keys())     # ["DDoS", "SYN Flood", ...]
ATTACK_TYPES = list(ATTACK_TYPE_MAPPING.values())   # ["DDoS", "SYN Flood", "UDP Flood", "SQL 注入", ...]

# 动态生成 AI 提示词
attack_types_str = "\n- ".join(ATTACK_TYPES_EN)
AI_PROMPT_COMMON = (
